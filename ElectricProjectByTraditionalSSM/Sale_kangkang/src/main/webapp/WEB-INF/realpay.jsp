...
<body>
	<!-- 这是固定的参数，支付宝给的 -->
	<form id="a" action="http://localhost:8383/payservice/payment"  method="POST" target="_blank">
		...
		<input type="hidden" name="busi_notify_url" value="http://localhost:8181/Sale_kangkang/real_pay_success.do"><!-- 支付系统通知前台系统 -->
